...
export const DEAD_MAN_SWITCH = "0xc05747dcbddc6a69be52a4c4dba1a222632a32ee" as const;
...
export const deadManSwitchAbi = [
  ...
  {
    type: "function", name: "attestInactive", stateMutability: "nonpayable",
    inputs: [{ name: "owner", type: "address" }], outputs: [],
  },
  {
    type: "function", name: "isGuardian", stateMutability: "view",
    inputs: [{ name: "owner", type: "address" }, { name: "guardian", type: "address" }],
    outputs: [{ type: "bool" }],
  },
  {
  ...
  {
    type: "function", name: "secondsUntilClaimable", stateMutability: "view",
    inputs: [{ name: "owner", type: "address" }], outputs: [{ type: "uint256" }],
  },
  {
    type: "function", name: "getSwitch", stateMutability: "view",
